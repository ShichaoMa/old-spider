...
def _convert_to(img, width, height):
    ...
    # 合并图层
    background.paste(img, (pos_x, pos_y), mask=img)
...
def convert_to(src_picture, dest_picture, width, height, *args):
    ...
    :return:
    """
    return _convert_to(src_picture, width, height)
...
if __name__ == "__main__":
    ...
    import requests
    new = BytesIO()
    url = "https://d2cekp7jyosbti.cloudfront.net/web/files/collections/5982aeceeb24c9.97768882.png"
    # with open("b.png", "wb") as f:
    #     f.write(requests.get(url, proxies={"https": "http://192.168.200.51:8123"}).content)
    convert_to(Image.open("b.png"), "", 800, 800).save("a.jpg", "jpeg")
