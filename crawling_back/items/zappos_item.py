...
from ..utils import re_search, chain_all, format_html_string, safely_json_loads, TakeAll
...
def description_processor(value):
    return value.replace("""<li>This product may have a manufacturer's warranty. Pdescription_processorlease visit the manufacturer's website or contact us at <a href="mailto:warranty@support.zappos.com">warranty@support.zappos.com</a> for full manufacturer warranty details.</li>""", "")
