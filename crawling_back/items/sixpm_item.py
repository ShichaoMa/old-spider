...
from ..utils import encode, chain_all, format_html_string, safely_json_loads, rid
...
class SixpmItem(BaseItem):
    ...
    product_info = Field(input_processor=MapCompose(encode, decodebytes, safely_json_loads), skip=True, default=dict())
